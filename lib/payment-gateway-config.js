...
const ACTIVE_PAYMENT_GATEWAYS = ['ghostspay', 'sunize', 'paradise'];
...
const ACTIVE_GATEWAY_FALLBACKS = {
    ghostspay: ['ghostspay', 'sunize', 'paradise'],
    sunize: ['sunize', 'ghostspay', 'paradise'],
    paradise: ['paradise', 'ghostspay', 'sunize']
};
